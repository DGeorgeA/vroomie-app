      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-20 right-4 z-[1000] w-[min(320px,90vw)] max-h-[90vh] overflow-y-auto sm:bottom-auto sm:top-1/2 sm:right-auto sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2"
          >
