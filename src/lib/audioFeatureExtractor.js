...
import { referenceIndex, initializeAudioDataset, audio_v6_calibration, audio_matching_mechanical_v2 } from '../services/audioDatasetService';
...
export async function startExtraction(callback) {
  ...
  try {
    ...
    // Spawn the Web Worker — v6 calibration takes priority
    const workerUrl = audio_v6_calibration
      ? new URL('../workers/AudioV6_Calibrator.worker.js', import.meta.url)
      : audio_matching_mechanical_v2
